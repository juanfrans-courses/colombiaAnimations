...
/* To do
- Get a new sample that starts in 1985
- Code the objects from the beginning with actor and type
- Double check 'minor' vs. 'adult' with new sample
- Change other (actor) to other or non identified
*/
...
boolean highlightMunicipalities = false;
...
public void draw() {
	...
	if (save){
		saveFrame("/Users/juansaldarriaga/Google_Drive/01_SIDL/02_SIDL_Projects/1507_Victims_and_Displacement_Colombia/07_Animations/02_AfterEffects/06_VictimsAnimation/AnimationFrames/32_Replacement_25pixels_3Spacing_####.png");
